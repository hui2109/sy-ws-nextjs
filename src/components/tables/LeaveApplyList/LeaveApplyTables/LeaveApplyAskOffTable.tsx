...
interface ILeaveApplyAskOffTable {
...
export default function LeaveApplyAskOffTable({personDateBansMap, banTypeColorMap, dateRange, currentUser, validBanNames}: ILeaveApplyAskOffTable) {
    ...
    const dataSource = daysInRange.map(day => {
        ...
        return {
            key: format_date,
            dt: format_date,
            myBan: personDateBansMap[currentUser]?.[format_date],
        }
    });
